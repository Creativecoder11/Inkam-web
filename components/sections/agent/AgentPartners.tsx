...
export default function AgentPartners() {
  ...
  return (
    <div className="w-full mx-auto py-15 md:py-25">
            ...
            {logos.slice(0, 4).map((logo, index) => (
              <div key={index} className="flex items-center justify-center w-full">
                <Image
                  src={logo}
                  alt="Partner logo"
                  className="max-h-8 md:max-h-16 w-auto object-contain grayscale opacity-80 hover:opacity-100 transition duration-300"
