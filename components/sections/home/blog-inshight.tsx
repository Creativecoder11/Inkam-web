...
export default function BlogInshight() {
  const articles = [
    {
      id: 1,
      date: "17-01-23",
      ...
      excerpt:
        "Lorem ipsum dolor sit amet consectetur. Duis nunc dignissim sit tempus elementum...",
      image: BlogImage,
    },
    {
      id: 2,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1  pt-12 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {articles.map((article) => (
            <div
              key={article.id}
              className=" rounded-3xl overflow-hidden bg-[#161518] transition-all duration-300 group"
            >
              {/* Image Container */}
