            ...
            <div className="text-white max-w-7xl mx-4 md:mx-auto">
                <div className="pt-10 md:pt-20">
                    <h1 className="text-2xl md:text-5xl font-semibold leading-[130%] md:tracking-[-2px]">
                        Inkam Cofounders Invited to Turtle Connect Symposium Meet & Greet with UK-Based Razor Capital
                    </h1>
                    <p className="text-[#CFCFCF] text-base md:text-lg leading-[140%] mt-2">
                    ...
                    <div className="flex flex-col gap-8 md:gap-12 md:mx-30">
                        <div className="flex flex-col gap-2 md:gap-4">
                            <p className="text-base md:text-lg leading-[140%]">
                                Inkam’s cofounders were invited to attend the Turtle Connect Symposium, a strategic gathering hosted by Turtle Venture, bringing together startup founders and ecosystem leaders for a high-impact Meet & Greet with Razor Capital, a UK-based venture financing firm.
                            </p>
                            <p className="text-base md:text-lg leading-[140%]">
                                The event welcomed 30+ startups, offering founders the opportunity to connect directly with international investors, exchange insights, and explore pathways for global venture collaboration. A select group of six startups pitched directly to a panel of investors, highlighting the growing momentum of Bangladesh’s startup ecosystem and its readiness for international capital engagement.
                            </p>
                            <p className="text-base md:text-lg leading-[140%]">
                                “Inkam is building for scale, impact, and real market adoption. Events like Turtle Connect Symposium matter because they create access—access to investor conversations, cross-border networks, and the exposure that helps founders sharpen both strategy and execution,” said Khalid Hossain, Cofounder, Inkam.
                            </p>
                        </div>
                        <div className="flex flex-col gap-2 md:gap-4">
                            <p className="text-2xl md:text-[32px] font-semibold leading-[120%]">
                                Bridging Bangladeshi Startups with Global Venture Capital
                            </p>
                            <p className="text-base md:text-lg leading-[140%]">
                                Turtle Venture’s Connect Symposium is designed to create meaningful investor access for founders—particularly through international firms that have supported Bangladesh’s top startups. The symposium reflected the growing interest in emerging markets and the potential of Bangladesh’s next generation of entrepreneurs.
                            </p>
                            <p className="text-base md:text-lg leading-[140%]">
                                Founders also exchanged experiences and market insights, reinforcing a shared ambition to raise standards across the ecosystem and accelerate readiness for international funding.
                            </p>
                            <p className="text-base md:text-lg leading-[140%]">
                                “We’re proud to be part of the conversations shaping Bangladesh’s startup future—where capital meets execution, and ideas meet real business momentum,” added Khalid Hossain. “We look forward to engaging in more global-facing platforms that strengthen founder-investor collaboration.”
                            </p>
                        </div>
                        <div className="flex flex-col gap-2 md:gap-4">
                            <p className="text-2xl md:text-[32px] font-semibold leading-[120%]">
                                Strengthening the Ecosystem Through Strategic Exposure
                            </p>
                            <p className="text-base md:text-lg leading-[140%]">
                                The symposium served as more than a networking session—it became a platform for founders to understand investor perspectives, refine their positioning, and build long-term relationships. As Bangladesh’s startup landscape evolves rapidly, such initiatives play a growing role in strengthening investor confidence and expanding cross-border opportunities for founders.
                            </p>
                        </div>
                        <div className="flex flex-col gap-2 md:gap-4">
                            <p className="text-2xl md:text-[32px] font-semibold leading-[120%]">
                            ...
                            <p className="text-base md:text-lg leading-[140%]">
                                Inkam is a Bangladesh-based technology platform focused on unlocking earning opportunities and enabling commerce at scale. Built to support individuals and businesses through smart systems and execution-driven growth, Inkam works to create wider access to income, distribution, and digital-first operational tools.
                            </p>
                        </div>
                        <div className="flex flex-col gap-2 md:gap-4">
                            <p className="text-2xl md:text-[32px] font-semibold leading-[120%]">
                                About Turtle Venture
                            </p>
                            <p className="text-base md:text-lg leading-[140%]">
                                Turtle Venture is a startup ecosystem enabler that supports founders through investor access, ecosystem partnerships, and exposure to local and international growth networks.
                            </p>
                        </div>
                        <div>
